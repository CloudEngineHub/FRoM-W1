...
sys.path.append(
    "/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/qiuxipeng-24028/workspace/hgpt/datasets/downloads/human_body_prior-master/src"
)
sys.path.append(
    "/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/qiuxipeng-24028/workspace/hgpt/datasets/downloads/body_visualizer/src"
)
        ...
        print(
            {
                ...
                if k in ["pose_body", "pose_hand", "betas"]
            }
        )
        body = bm(
            **{
                k: v.to(comp_device)
                for k, v in motion_parms.items()
                if k in ["pose_body", "pose_hand"]
            }
        )
        body_mesh_wfingers = trimesh.Trimesh(
